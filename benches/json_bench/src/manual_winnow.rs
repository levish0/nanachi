...
mod tests {
    ...
    fn parses_sample_payload() {
        let payload = super::manual_winnow_test_data();
        parse_json(&payload).expect("manual winnow parser should accept generated payload");
    }
}

#[cfg(test)]
fn manual_winnow_test_data() -> String {
